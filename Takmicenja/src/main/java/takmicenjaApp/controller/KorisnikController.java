...
import takmicenjaApp.dto.AuthKorisnikDto;
import takmicenjaApp.dto.KorisnikDTO;
import takmicenjaApp.dto.KorisnikPromenaLozinkeDto;
import takmicenjaApp.dto.KorisnikRegistracijaDTO;
import takmicenjaApp.model.Korisnik;
import takmicenjaApp.security.TokenUtils;
import takmicenjaApp.service.KorisnikService;
import takmicenjaApp.support.KorisnikDtoToKorisnik;
import takmicenjaApp.support.KorisnikToKorisnikDto;

@RestController
@RequestMapping(value = "/api/korisnici")
public class KorisnikController { @Autowired
